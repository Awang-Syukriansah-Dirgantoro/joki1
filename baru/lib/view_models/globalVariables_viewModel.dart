...
import 'package:baru/models/cartItem.dart';
// import 'package:firebase_auth/firebase_auth.dart';
import 'package:baru/models/Product.dart';
...
class globalVars with ChangeNotifier {
  ...
  Future getSpecificProd(id) async {
  ...
  Future fillCartList(var CartProds) async {
    ...
    //   Future tempProd = getSpecificProd(CartProds[i]['id']);
    //   print(tempProd);
  ...
  Future getUserCart(int u) async {
  ...
  Future getUserInfo(int u) async {
    // DocumentSnapshot documentSnapshot = await UsersInformation.doc(u.uid).get();
    // _UserInfo = documentSnapshot.data();
    // print(_UserInfo);
  }

  Future DeleteItemFromCart(int u, int index) async {
  ...
  Future addCartItems(int u, List<cartItem> c) async {
